...
/*
    Renders the actual model in 3D space,
    rotating it a full 360 degrees to show it from all angles
*/
...
class ModelView extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        if(nextProps.current !== this.props.currnt) {
    ...
    render() {
        ...
        return(
            <View>
                <AmbientLight intensity={1.0} cikir={'#fff'}/>
                <PointLight
                    intensity={0.4}
